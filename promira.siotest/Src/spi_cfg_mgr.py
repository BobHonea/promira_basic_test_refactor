...
class configVal:
  ...
  spi_config_options=spiConfiguration( 
    ...
    #clk_kHz         = [ 10000, 11000, 12000, 20000 ],
    clk_kHz         = [ 850, 1000, 2000, 5000, 7500, 10000, 12000,  15000, 17500, 20000 , 22000, 25000,  27500, 30000] , #32500, 35000, 37500, 40000, 42500, 45000, 47500, 50000, 52500, 55000, 57500, 60000 ],
