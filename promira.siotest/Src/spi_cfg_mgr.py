...
class configVal:
  ...
  spi_config_options=spiConfiguration( 
    ...
    clk_kHz         = [ 1000, 2500, 5000, 7500, 10000, 12500, 15000, 17500, 20000 , 22500, 30000, 32500, 35000, 37500, 40000, 42500, 45000, 47500, 50000, 52500, 55000, 57500, 60000, 62500, 65000 ],
