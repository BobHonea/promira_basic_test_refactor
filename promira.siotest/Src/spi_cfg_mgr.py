...
class configVal:
  ...
  spi_config_options=spiConfiguration( 
    ...
    clk_kHz         = [8000, 10000, 12000, 14000, 15000, 16000, 17000],
    #clk_kHz         = [ 2000 , 5000, 7500, 10000,11000, 12000, 13000, 14000, 15000, 16000, 17000, 18000, 19000, 20000, 22000 ,25000, 27500, 30000, 32500, 35000, 37500, 40000 ],
