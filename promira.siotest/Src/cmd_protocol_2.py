...
SPICMDTYPE_20=SpiCmdSpec(iowMax=SPIIO_SINGLE,  cmd=w1CmdPhase, address=w1L4AddrPhase, data=w1Data_1plus)
...
SPICMD_WNVCFG     = [WNVCFG,    0x1B,         IOTYPE_WRITE]
