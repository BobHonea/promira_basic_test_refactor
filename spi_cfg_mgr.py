...
class configVal:
  ...
  spi_config_options=spiConfiguration( 
    ...
    #clk_kHz         = [1000, 3000, 5000, 7500, 10000, 12000, 14000, 15000, 16000, 18000],
    clk_kHz         = [ 2000 , 7500, 10000,13000, 14000, 15000, 16000, 20000, 25000, 27000, 29000, 30000, 32000 ],
    #clk_kHz         = [ 5000, 7500, 10000, 12000,  15000, 17500, 20000 , 22000, 25000,  27500, 30000, 32500, 35000, 37500, 40000 , 42500, 45000, 47500, 50000 ],
